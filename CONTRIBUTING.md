Contributing to Jackpot Core
============================

The Jackpot Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Jackpot Core project, and is not to be
confused with overall Jackpot Network Protocol consensus changes.

Whether a pull request is merged into Jackpot Core rests with the project merge
...
Patches that change Jackpot consensus rules are considerably more involved than
...
Where a patch set proposes to change the Jackpot consensus, it must have been
...
The project leader is the release manager for each Jackpot Core release.
