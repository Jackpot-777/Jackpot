...
RESOURCES += src/qt/jackpot.qrc src/qt/jackpot_locale.qrc

TRANSLATIONS += src/qt/locale/jackpot_bg.ts \
                src/qt/locale/jackpot_de.ts \
                src/qt/locale/jackpot_en.ts \
                src/qt/locale/jackpot_es.ts \
                src/qt/locale/jackpot_fi.ts \
                src/qt/locale/jackpot_fr.ts \
                src/qt/locale/jackpot_it.ts \
                src/qt/locale/jackpot_ja.ts \
                src/qt/locale/jackpot_pl.ts \
                src/qt/locale/jackpot_pt.ts \
                src/qt/locale/jackpot_ru.ts \
                src/qt/locale/jackpot_sk.ts \
                src/qt/locale/jackpot_sv.ts \
                src/qt/locale/jackpot_vi.ts \
                src/qt/locale/jackpot_zh_CN.ts \
                src/qt/locale/jackpot_zh_TW.ts
