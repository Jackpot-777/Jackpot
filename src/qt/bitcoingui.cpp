                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Jackpot Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Jackpot address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and jackpot: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Jackpot Core"), this);
    aboutAction->setStatusTip(tr("Show information about Jackpot Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Jackpot"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Jackpot addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Jackpot addresses"));
    ...
    openAction->setStatusTip(tr("Open a Jackpot: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Jackpot Core help message to get a list with possible Jackpot command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Jackpot Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Jackpot network", "", count));
}
...
{
    QString strTitle = tr("Jackpot Core"); // default title
...
/** Creates context menu, its actions, and jackpots up all the relevant signals for mouse events. */
