...
int nAnonymizeJackpotAmount = 1000;
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "jackpot" is a composite category enabling all Jackpot-related debug output
            if (ptrCategory->count(string("jackpot"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "jackpot.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "jackpotd.pid"));
