...
Value mnbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a Jackpot initiative\n"
            "  vote-alias         - Vote on a Jackpot initiative\n"
            "  vote               - Vote on a Jackpot initiative/budget\n"
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"jackpot-address\" monthy-payment \"fee-tx\"\n"
