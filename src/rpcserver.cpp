...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Jackpot features */
        {"jackpot", "masternode", &masternode, true, true, false},
        ...
        {"jackpot", "mnbudget", &mnbudget, true, true, false},
        ...
        {"jackpot", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"jackpot", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use jackpotd, or the -server option to jackpot-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
