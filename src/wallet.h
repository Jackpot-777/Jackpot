...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 JACKPOT at the same time
...
enum ZerocoinSpendStatus {
    ZJACKPOT_SPEND_OKAY = 0,                            // No error
    ZJACKPOT_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZJACKPOT_WALLET_LOCKED = 2,                         // Wallet was locked
    ZJACKPOT_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZJACKPOT_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZJACKPOT_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZJACKPOT_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZJACKPOT_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZJACKPOT_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZJACKPOT_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZJACKPOT_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZJACKPOT_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZJACKPOT_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZJACKPOT_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZJACKPOT_SPENT_USED_ZJACKPOT = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZJackpotAutoBackups(bool fEnabled)
    {
