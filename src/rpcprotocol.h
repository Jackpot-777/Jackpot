...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Jackpot is not connected
    ...
    RPC_WALLET_PASSJACKPOTASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
