...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("041c96e7f14af8515f44d6bd4c8e9b8956be7679cd78d52d8bfed86b3404dd6ac4f2c34b43e9a8e273770ec473fee847a007f95ebdcc7a7a8d58062bbffa217434");
        nDefaultPort = 17771;
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0478505c5bc438e08c0c8de26a661bc5a4453378d0b149fbf17cb3e1499b1d3e552fe5faaa253673c5349b461bd964a2ee860c114e9d2b9fdb0328f37ed356ed54") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1565765454;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1071713;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000003a77c17296ef80130591b732c9e7f686f6e3687c6d30da7de9377a6634a"));
        assert(genesis.hashMerkleRoot == uint256("0x348c17f032877751c1a60eaf30d366bf7740afb45000e2fbe18e29589190ce40"));

	vSeeds.push_back(CDNSSeedData("149.248.63.235", "149.248.63.235"));
        vSeeds.push_back(CDNSSeedData("136.244.105.244", "136.244.105.244"));
        vSeeds.push_back(CDNSSeedData("209.250.251.55", "209.250.251.55"));
        vSeeds.push_back(CDNSSeedData("95.179.186.163", "95.179.186.163"));
	...
	strSporkKey = "04C1FBF00CBCD62421E67577E8DC64E2F5311BA6FEE0184D723D3264A128D487D8C7E2B18A0F607532C5F8E142DAFDD435DDC512A7B82570CD34087135C0E10AA4";
        strObfuscationPoolDummyAddress = "7Bg8mBGzx2yRD8k7GavRutcRPVMmA81nYN";
        nStartMasternodePayments = 1565765454;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Jackpot: 1 day
        nTargetSpacing = 1 * 60;  // Jackpot: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Jackpot: 1 day
        nTargetSpacing = 1 * 60;        // Jackpot: 1 minutes
